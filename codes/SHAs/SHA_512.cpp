...
void separator(string getBlock)//message scheduling function
{
...
string SHA512(string myString)
{
    ...
    int64 AA, BB, CC, DD, EE, FF, GG, HH;//initial values
 ...
 // abc 
   ...
   // cout<<s1024<<endl;//added
    ...
    for (int letsgo = 0;
        ...
        separator(Blocks[letsgo]);//stretches messages to 80 words
